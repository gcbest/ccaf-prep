...
|---|---|---|
| Agentic Architecture & Orchestration | 27% | 03-building-with-the-claude-api (agentic orchestration, managed agents, agent loop) |
...
| Tool Design & MCP Integration | 18% | 03-building-with-the-claude-api (tool design), 06-introduction-to-mcp |
| Context Management & Reliability | 15% | 03-building-with-the-claude-api (context management), 07-claude-code-in-action (Claude Code context/reliability) |
...
1. Agentic Architecture & Orchestration (27%) — 03-building-with-the-claude-api: agent loop, managed agents, workflows vs. agents, all four workflow patterns.
